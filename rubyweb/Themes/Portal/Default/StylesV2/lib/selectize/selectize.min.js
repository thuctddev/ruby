...
(function (root, factory) {
    ...
    Sifter.prototype.tokenize = function (query) {
        ...
        query = query.replace('â', 'a').replace('ă', 'a').replace('ê', 'e').replace('ô', 'o').replace('ơ', 'o').replace('ư', 'u').replace('Â', 'A').replace('Ă', 'A').replace('Ê', 'E').replace('Ô', 'O').replace('Ơ', 'O').replace('Ư', 'U');
...
(function (root, factory) {
    ...
    $.extend(Selectize.prototype, {
		 ...
		 */
        blur: function (dest) {
            if (this.settings.chooseItemOnBlur) {
